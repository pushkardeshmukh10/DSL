...
'''
gescoe@gescoe-OptiPlex-3020:~/Downloads$ python3 queue.py
1. Add Event.
2. Processed Event
3. Cancel Event
4. Display Events
5. EXIT!!
Enter your Choice:- 1
Enter Events you want to add:- 1
Event '1' is added
1. Add Event.
2. Processed Event
3. Cancel Event
...
5. EXIT!!
Enter your Choice:- 1
Enter Events you want to add:- 2
Event '2' is added
1. Add Event.
2. Processed Event
3. Cancel Event
...
5. EXIT!!
Enter your Choice:- 1
Enter Events you want to add:- 3
Event '3' is added
1. Add Event.
2. Processed Event
3. Cancel Event
...
5. EXIT!!
Enter your Choice:- 3
Enter event you want to cancel:- 2
Event 2 is Canceled
1. Add Event.
2. Processed Event
3. Cancel Event
